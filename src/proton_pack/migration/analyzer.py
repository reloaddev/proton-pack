...
from proton_pack.migration.rules.check_for_not_null_constraints_dropped import check_for_not_null_constraints_dropped
...
def analyze_ast(ast: List[exp.Expression]) -> Dict[str, bool]:
    ...
    Current checks:
      ...
      - NOT_NULL_CONSTRAINTS_DROPPED: True if there are any ALTER TABLE ... DROP NOT NULL operations.
    """
    return {
        ...
        "NOT_NULL_CONSTRAINTS_DROPPED": check_for_not_null_constraints_dropped(ast),
    }
